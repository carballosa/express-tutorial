    ...
    async.parallel({
        ...
        genres: function(callback) {
            ...
            */
            ...
            for (var i = 0; i < results.genres.length; i++) {
                genres[i] = {
                    _id: results.genres[i]._id.toString(), 
                    name: results.genres[i].name
                };
            ...
            res.render('book_form', { title: 'Update Book', authors:results.authors, genres:genres, book: results.book });
        });
